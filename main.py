...
def buy_ETH():
  ...
  balance = cash - amount
  print("ETH of ",amount, "bought on ",date, "at ", time, "New balance is ", balance )
...
if amount > 0 and amount <= cash
    ...
    print("Ksh ",amount, "withdraw successfully from agent number ",Agent, "on", date,"balance is ",remaining_cash )
else:
